...
import { X, Smartphone, Download, ExternalLink, QrCode, ShieldCheck, Sparkles } from "lucide-react";
      ...
      >
        ...
        <div className="mt-6 space-y-3">
          ...
          <a
            ...
            className="flex items-center justify-between w-full p-4 rounded-xl bg-white dark:bg-stone-800/80 border border-[#E8E0D4] dark:border-stone-700 hover:border-[#3A7D3A] dark:hover:border-[#52A752] hover:shadow-md transition-all group"
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#FAF7F2] dark:bg-stone-700 flex items-center justify-center text-stone-800 dark:text-stone-200 group-hover:scale-105 transition-transform">
              ...
              <div className="text-left">
                ...
                <div className="text-base font-bold text-stone-900 dark:text-stone-100 flex items-center gap-1.5">
                  iOS & Apple TestFlight
                  <ExternalLink className="w-3.5 h-3.5 opacity-60 group-hover:opacity-100" />
                </div>
              </div>
            </div>
            <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-950/50 text-[#3A7D3A] dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60">
              Direct Preview
            </span>
          </a>
          ...
          >
            ...
            <span className="text-xs font-medium px-2.5 py-1 rounded-full bg-amber-50 dark:bg-amber-950/50 text-[#D4A84B] dark:text-amber-300 border border-amber-200 dark:border-amber-800/60">
              Direct Build
            </span>
          </a>

          {/* Expo Development instructions */}
          <div className="p-4 rounded-xl bg-stone-100/70 dark:bg-stone-800/40 border border-[#E8E0D4] dark:border-stone-700/60 text-xs text-stone-600 dark:text-stone-400">
            <div className="flex items-center gap-2 font-semibold text-stone-800 dark:text-stone-200 mb-1">
              <QrCode className="w-4 h-4 text-[#3A7D3A]" />
              Run locally via Expo CLI:
            </div>
            <code className="block bg-stone-200/80 dark:bg-stone-900 px-2.5 py-1.5 rounded font-mono text-[11px] text-stone-800 dark:text-stone-300 select-all my-1.5">
              cd selah-app &amp;&amp; npx expo start
            </code>
            <p className="text-[11px] text-stone-500 dark:text-stone-400">
              Scan the terminal QR code in Expo Go to test live on your physical iOS or Android phone.
            </p>
          </div>
        </div>
